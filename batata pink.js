...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(0,153,255,0.698)").ss(3,0,1).p("");
	this.shape_2.setTransform(102.975,173.225);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#AED4FF").s().p("");
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#AED4FF").s().p("");
	this.shape_5.setTransform(103,170.975);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("rgba(0,153,255,0.698)").ss(3,0,1).p("");
	this.shape_6.setTransform(102.9875,164.975);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#AED4FF").s().p("");
	this.shape_7.setTransform(103,164.975);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("rgba(0,153,255,0.698)").ss(3,0,1).p("");
	this.shape_8.setTransform(102.8652,160.125);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#AED4FF").s().p("");
	this.shape_9.setTransform(102.8652,160.125);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("rgba(0,153,255,0.698)").ss(3,0,1).p("");
	this.shape_10.setTransform(102.8915,154.425);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#AED4FF").s().p("");
	this.shape_11.setTransform(102.8915,154.425);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("rgba(0,153,255,0.698)").ss(3,0,1).p("");
	this.shape_12.setTransform(102.9826,148.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#AED4FF").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FF99CC").ss(13,1,1).p("AB2xMIXxjmIAAMOIAAMOAB2xMIAOOWIAPOTA5mD3IAAw6IbckJA5mD3IAAQ8A5mD3IbqmtIXjlu");
	this.shape_1.setTransform(163.85,133.075);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFC6E2").s().p("A5mD3IAAw6IbbkJIAPOWIgPuWIXxjmIAAMOI3iFuI7qGtIbqmtIAOOTI74JWgACSLdgACEi2IXiluIAAMOI3UHzgAZmokg");
...
if (reversed == null) { reversed = false; }
	...
	this.actionFrames = [0];
	this.streamSoundSymbolsList[0] = [{id:"AcousticBlues",startFrame:0,endFrame:642,loop:1,offset:0}];
	// timeline functions:
	this.frame_0 = function() {
		this.clearAllSoundStreams();
		 
		var soundInstance = playSound("AcousticBlues",0);
		this.InsertIntoSoundStreamData(soundInstance,0,642,1);
		var self = this;
		self.stop();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_27.png?1598435506105", id:"CachedBmp_27"},
		{src:"images/batata pink_atlas_1.png?1598435506002", id:"batata pink_atlas_1"},
		{src:"sounds/AcousticBlues.mp3?1598435506105", id:"AcousticBlues"}
	],
	preloads: []
};
